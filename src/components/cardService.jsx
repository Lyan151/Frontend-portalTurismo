    ...
    return(
        ...
        <div className="w-full max-w-sm sm:max-w-md md:max-w-lg bg-white border-gray-200 rounded-2xl shadow-md overflow-hidden m-2 flex flex-col ml-auto mr-auto">
            ...
            <div className="p-4 flex flex-col flex-grow">
                ...
                <a href={props.link} className="mt-4 inline-block bg-green-500 text-white px-4 py-4 rounded-3xl text-center hover:bg-green-300 tramsition duration-300">{props.botao}</a>
            </div>
